...
public class StmtLibrary {
	...
	public static PreparedStatement getPSPNLGROUP(String b1, String b2) throws Exception {
		PreparedStatement pstmt = conn.prepareStatement("SELECT PNLNAME, ITEMNAME, HIDDEN, ITEMLABEL, FOLDERTABLABEL, SUBITEMNUM FROM PSPNLGROUP WHERE PNLGRPNAME = ? AND MARKET = ? ORDER BY SUBITEMNUM");
		pstmt.setString(1, b1);
		pstmt.setString(2, b2);
		return pstmt;
	}
