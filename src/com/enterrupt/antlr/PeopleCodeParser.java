...
public class PeopleCodeParser extends Parser {
	...
	public static class RContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(PeopleCodeParser.ID, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PeopleCodeListener ) ((PeopleCodeListener)listener).enterR(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PeopleCodeListener ) ((PeopleCodeListener)listener).exitR(this);
		}
	}
